...
public class HollowPurpleExplosion extends JujutsuProjectile {
    ...
    public void tick() {
        ...
        if (this.getTime() - 1 == 0) {
            ...
            float radFactor = Math.clamp(owner.distanceTo(this)/radius,0.0F,1.0F);
            owner.hurt(JJKDamageSources.indirectJujutsuAttack(owner, owner, JJKAbilities.HOLLOW_PURPLE.get()), (this.getPower() * 0.5F)*radFactor);
